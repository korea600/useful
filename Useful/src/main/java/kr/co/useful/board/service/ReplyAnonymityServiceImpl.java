...
import kr.co.useful.board.persistence.ReplyAnonymityDAO;

@Service
public class ReplyAnonymityServiceImpl implements ReplyAnonymityService{
	
	@Inject
	private ReplyAnonymityDAO dao;
