						...
						<div class="list_number">
                            ...
                            <div class="input-group" >
                              ...
                              <select id="searchType" name="searchType" class="form-control" style="width: 15%;height: 35px;">
                                ...
                                <input value="${cri.keyword }" name="keyword" id="btn-input" type="text" class="form-control input-sm" placeholder="검색어를 입력해주세요.." style="height: 35px;width: 85%;size: 30;"/>
								...
								<tbody>
									<c:forEach items="${list }" var="BoardVO">
										<tr>
											...
											<td><a href="/useful/board/anonymity/readPage${pageMaker.serach(pageMaker.cri.page) }&serial=${BoardVO.serial}">${BoardVO.title } [${BoardVO.replycnt }]</a></td>
