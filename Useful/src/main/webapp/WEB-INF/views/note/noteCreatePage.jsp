...
<%@include file="../login/Sidebar.jsp" %>
                                ...
                                <div class="col-lg-6">
                                    <form method="post" action="noteCreatePage">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="text" id="sendman" value="" name="sendman" readonly="readonly"></input>
   ...
   /*  $("#userfind").on("click",function(){
		var open=window.open('finduserPage','finduserPage','toolbar=no,location=no,status=no'
				+'menubar=no,scrollbars=no,resizable=0,width=800,height=300,top=100,left=100');
		open.focus();
