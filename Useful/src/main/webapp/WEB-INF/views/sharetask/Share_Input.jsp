		...
		<form action="#" method="post">
			<table border="1"
				...
				<tr>
					...
					<td align="center" width="750px"></td>
				</tr>
				<tr>
				...
				<tr>
					<td colspan="2" style="padding:0;"><textarea name="contents" style="font-size:15px; width: 900px; margin: 0; height:500px; border:0;"></textarea></td>
				</tr>
				<tr>
