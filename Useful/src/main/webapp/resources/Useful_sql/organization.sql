...
insert into tbl_emp (empno, ename, pass, ssn, phone, address, hiredate, deptno, position, manager, leave, account, bank)
values (1001, '채효원', '1111','121212-1234567','010-123-4567','가산디지털',sysdate, 0, '부장',null, 30,'123456-7890123','한국은행');
insert into tbl_emp (empno, ename, pass, ssn, phone, address, hiredate, deptno, position, manager, leave, account, bank)
values (1002, '박지혜', '1111','121212-1234567','010-123-4567','가산디지털',sysdate, 0, '대리',null, 30,'123456-7890123','한국은행');
insert into tbl_emp (empno, ename, pass, ssn, phone, address, hiredate, deptno, position, manager, leave, account, bank)
values (1003, '안선영', '1111','121212-1234567','010-123-4567','가산디지털',sysdate, 0, '사원',null, 30,'123456-7890123','한국은행');
insert into tbl_emp (empno, ename, pass, ssn, phone, address, hiredate, deptno, position, manager, leave, account, bank)
values (1004, '이대원', '1111','121212-1234567','010-123-4567','가산디지털',sysdate, 0, '사원',null, 30,'123456-7890123','한국은행');
insert into tbl_emp (empno, ename, pass, ssn, phone, address, hiredate, deptno, position, manager, leave, account, bank)
values (1005, '전성원', '1111','121212-1234567','010-123-4567','가산디지털',sysdate, 0, '사원',null, 30,'123456-7890123','한국은행');
-- 컬럼 데이터 크기 수정
